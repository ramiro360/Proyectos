...
public partial class WHISKY : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ctrl.BorderStyle = BorderStyle.Groove;
        ctrl.Text = " Marcas de Whisky";
        if (!this.IsPostBack)
        {
            chklst.Items.Add("Red Label");
            chklst.Items.Add("Chivas");
            chklst.Items.Add("Jack Daniels");
            chklst.Items.Add("Chanceler");
        }
    }
    protected void cmdOK_Click(object sender, EventArgs e)
    {
        lblResult.Text = "El precio total es: <b> 60 soles";
